...
class BCG extends React.Component {
	render() {
		const text_is = [
            'Hljómsveitin Benny Crespos‘s Gang var stofnuð árið 2003 af þeim Magnúsi Øder Kristinssyni, Helga Rúnari Gunnarssyni, Magnúsi Guðmundssyni og Bassa Ólafssyni. Lovísa Elísabet Sigrúnardóttir (Lay Low) bættist fljótlega í hópinn og um það leyti hætti Magnús Guðmundsson.',
		...
		const text_en = [
            "The band Benny Crespos's Gang was formed in 2003 by Magnús Øder Kristinsson, Helgi Rúnar Gunnarsson, Magnús Guðmundsson and Bassi Ólafsson. Lovísa Elísabet Sigrúnardóttir (Lay Low) soon joined the group and about that time Magnús Guðmundsson left.",

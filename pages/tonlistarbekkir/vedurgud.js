...
class Vedurgud extends React.Component {
	render() {
		const text_is = [
            'Tónlistarmaðurinn Ingólfur Þórarinsson, betur þekktur sem Ingó Veðurguð byrjaði ungur að þreifa sig áfram í tónlistinni. Fljótlega á tvítugsárunum var hann þekktur um Suðurlandið fyrir gítar- og sönghæfileika sína.',
            'Árið 2008 gaf hann svo út ásamt hljómsveit sinni, Ingó og Veðurguðirnir, sumarsmellinn Bahama sem var efst á Íslenska lagalistanum í níu vikur. Hljómsveit hans gaf í kjölfarið út albúmið Góðar stundir árið 2009 sem innihélt smelli eins og Nóttin er liðin, Gestalistinn og Argentína.',
            'Næstu árin var Ingó þó eins síns liðs og tróð upp á öllum helstu skemmtunum á landinu, enda Ingó gæddur þeim hæfileika að geta haldið uppi stemningu á heilu balli með kassagítarnum einum. Það sýndi sig og sannaði að Ingó getur hrifið fólk með sér í söng þegar hann var fenginn til þess að taka við brekkusöngnum á Þjóðhátíð í Eyjum af engum öðrum heldur en Árna Johnsen árið 2013.',
            'Síðan þá hefur Ingó glætt þjóðhátíðarhjörtun eldi, bæði í Dalnum og hjá þeim sem heima sitja og hlusta á í útvarpinu.', 
